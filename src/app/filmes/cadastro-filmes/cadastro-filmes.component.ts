    ...
    () => {
      const config = {
        data: {
          ...
          descricao: 'Não conseguirmos editar o seu registro, favor tentar novamente mas tarde!',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar'
        } as Alerta
      };
    ...
    () => {
      const config = {
        data: {
          ...
          descricao: 'Não conseguirmos salvar o seu registro, favor tentar novamente mas tarde!',
          corBtnSucesso: 'warn',
          btnSucesso: 'Fechar'
        } as Alerta
      };
